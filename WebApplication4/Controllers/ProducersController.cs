...
namespace WebApplication4.Controllers
{
    ...
    public class ProducersController : ControllerBase
    {
        ...
        public ProducersController(WebApplication4Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Producer>> PostProducer(Producer producer)
        {
          if (_context.Producers == null)
          {
              return Problem("Entity set 'WebApplication4Context.Producers'  is null.");
          }
            _context.Producers.Add(producer);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetProducer", new { id = producer.Pr_Id }, producer);
        }
        ...
        {
            return (_context.Producers?.Any(e => e.Pr_Id == id)).GetValueOrDefault();
        }
    }
}
