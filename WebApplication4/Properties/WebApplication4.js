...
function addCategory() {
    ...
    const addSexTextbox = document.getElementById('add-sex');

    const category = {
        name: addNameTextbox.value.trim(),
        sex: addSexTextbox.value.trim(),
    };
...
function displayEditForm(id) {
    ...
    document.getElementById('edit-sex').value = category.sex;
...
function _displayCategories(data) {
    ...
    data.forEach(category => {
        ...
        let textNodeInfo = document.createTextNode(category.sex);
